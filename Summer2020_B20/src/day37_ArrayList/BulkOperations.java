...
public class BulkOperations {
    public static void main(String[] args) {
        ...
        nums.addAll(Arrays.asList(1,1,1,1,1,2,2,3,4,5,5,6,7,8,9,10,11,11,11,11,11,12,13));

        System.out.println(nums);

        // remove all 1,2,3,10,11
        ...
        // only keep the elements that are either 1, or2, or 3, or 9
