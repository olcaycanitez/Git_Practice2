...
public class multiD_Array_Practice1 {
    public static void main(String[] args) {
        ...
        for(int i = 0; i <= Batch20.length-1; i++ ){ // bu batch 20 deki gruplari getiriyor
            String[] eachGroup = Batch20[i];
            //System.out.println(Arrays.toString(eachGroup)  );
            for(int j = 0; j <= eachGroup.length-1; j++){ // bu batch 20 deki gruplarin icerisinde yer alan isimleri getiriyor
